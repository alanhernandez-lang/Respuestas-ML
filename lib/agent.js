...
function buildPromptHeader({ buyerName, itemTitles, orderCreationDate }) {
...
function buildContentParts({ buyerName, itemTitles, messages, orderCreationDate }, imagesByMessageIndex) {
  const parts = [{ text: buildPromptHeader({ buyerName, itemTitles, orderCreationDate }) }];
...
async function generateDraftAnswer({ buyerName, itemTitles, messages, token, orderCreationDate }) {
  ...
  const parts = buildContentParts({ buyerName, itemTitles, messages, orderCreationDate }, imagesByMessageIndex);
