...
// régimen fiscal como si nunca los hubiera dado.
...
dentro de una foto/PDF que el cliente adjuntó (por ejemplo su Constancia de Situación Fiscal del
SAT, que suele traer razón social, RFC, código postal fiscal y régimen fiscal ya impresos — revisa
esas imágenes con atención, no asumas que faltan solo porque el cliente no las escribió a mano).
Nunca cuentes un dato que haya escrito o adjuntado el vendedor, y nunca lo inventes ni lo completes
por suposición o contexto:
${fieldsList}
